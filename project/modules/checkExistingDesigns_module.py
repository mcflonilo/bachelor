...
from modules.multipleBSInput_module import MultipleBSDimensionWindow

class CheckExistingDesignsWindow:
    def __init__(self, frame, main_frame, root):
        ...
        self.bsDimension_app = MultipleBSDimensionWindow(bsDimension_frame, frame, self.show_frame)
...
def main():
    ...
    designBS_app = CheckExistingDesignsWindow(designBS_frame, main_frame, root)
